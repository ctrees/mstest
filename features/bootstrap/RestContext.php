...
class RestContext extends BehatContext
{
    ...
    public function iRequest($pageUrl)
    {
        ...
        $baseUrl 			= "http://cat9sltest.herokuapp.com:80/api";
        //$accessToken        = $this->getParameter('access_token');
        $accessString       = "?access_token=yR34GfVqBUuD13Z2PBiqwClmPh7iVgDVAagJ2SEJbi6zhzdENJU6ZPBDi5tIQrta";
        $this->_requestUrl 	= $baseUrl.$pageUrl.$accessString;
